...
var JSTableDefaultConfig = {
    ...
    labels: {
        ...
        perPage: "{select} 条/页",
        noRows: "没有查询到数据",
        info: "显示 第 {start} - {end} 条数据 ，总共 {rows} 条数据",
        loading: "Loading...",
        infoFiltered: "显示 第 {start} - {end} 条数据，总共 {rows} 条数据 (从 {rowsTotal} 条数据中筛选)"
    },
    ...
    return _createClass(e, [{
        key: "_build", value: function () {
            ...
            if (t = t.replace("{info}", "<div class='" + e.classes.info + "'></div>"), e.perPageSelect) {
                ...
                s.className = e.classes.selector, e.perPageSelect.forEach((function (t) {
                    var a = t === e.perPage, r = new Option(t, t, a, a);
                    s.add(r)
        ...
        key: "getPageData", value: function () {
            ...
            var e = this._getPageStartIndex(), t = this._getPageEndIndex();
        ...
        key: "sort", value: function (e, t) {
            var a = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], s = this;
            if (this.sortColumn = e || 0, this.sortDirection = t, this.sortColumn < 0 || this.sortColumn > this.table.getColumnCount() - 1) return !1;
            var r = this.table.header.getCell(this.sortColumn), n = this.table.dataRows,
            ...
            i.forEach((function (e) {
                ...
                var a = e.getCellContent(s.sortColumn).toLowerCase(), r = t.getCellContent(s.sortColumn).toLowerCase();
        ...
        key: "setMessage", value: function (e) {
            var t = this.table.getColumnCount(), a = document.createElement("tr");
        ...
        key: "_buildColumns", value: function () {
            ...
            this.config.columns && this.config.columns.forEach((function (s) {
                isNaN(s.select) || (s.select = [s.select]), s.select.forEach((function (r) {
                    ...
                    s.hasOwnProperty("searchable") && (n.addAttribute("data-searchable", s.searchable), !1 === s.searchable && e.columnsNotSearchable.push(r))
                }))
            })), this.table.header.getCells().forEach((function (s, r) {
                null === s.isSortable && s.setSortable(e.config.sortable), s.isSortable && (s.addClass(e.config.classes.sorter), s.hasSort && (t = r, a = s.sortDirection))
            })), null !== t && e.sort(t, a, !0)
        }
    }]), e
    ...
    return _createClass(e, [{
        ...
        key: "getFooterRow", value: function () {
            return this.rows.find((function (e) {
                return e.isFooter
            }))
        }
    ...
    return _createClass(e, [{
        ...
        key: "getCellContent", value: function (e) {
            return this.getCell(e).getContent()
        }
    }, {
        key: "getFormated", value: function (e) {
            var t = document.createElement("tr"), a = this;
        ...
        key: "setCellContent", value: function (e, t) {
            this.cells[e].setContent(t)
        }
    }, {
        key: "setCellClass", value: function (e, t) {
            this.cells[e].addClass(t)
        }
    }], [{
        key: "createFromData", value: function (t) {
    ...
    function e(t) {
        _classCallCheck(this, e), this.content = t.innerHTML, this.className = "", this.element = t, this.hasSortable = t.hasAttribute("data-sortable"), this.isSortable = this.hasSortable ? "true" === t.getAttribute("data-sortable") : null, this.hasSort = t.hasAttribute("data-sort"), this.sortDirection = t.getAttribute("data-sort"), this.classes = [];
        var a = this;
    ...
    return _createClass(e, [{
        ...
        key: "setClass", value: function (e) {
            this.className = e
        }
    }, {
        key: "setSortable", value: function (e) {
            this.isSortable = e
        }
    }, {
        ...
        key: "addAttribute", value: function (e, t) {
            this.attributes[e] = t
        }
    }]), e
    ...
    return _createClass(e, [{
        ...
        key: "render", value: function () {
            var e = this.instance.config, t = this.getPages(), a = document.createElement("ul");
            if (t > 1) {
        ...
        key: "createItem", value: function (e, t, a, s) {
            var r = document.createElement("li");
            return r.className = e, r.innerHTML = s ? "<span>" + a + "</span>" : '<a href="#" data-page="' + t + '">' + a + "</a>", r
        }
    }, {
        key: "isValidPage", value: function (e) {
            return e > 0 && e <= this.getPages()
        }
    }, {
        key: "truncate", value: function () {
            var e, t = this, a = t.instance.config, s = 2 * a.pagerDelta, r = t.instance.currentPage,
                n = r - a.pagerDelta, i = r + a.pagerDelta, o = this.getPages(), l = [], c = [];
            ...
            } else for (var h = 1; h <= this.getPages(); h++) c.push(this.createItem(h === r ? "active" : "", h, h));
            return c
        }
    }]), e
}();